#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Time    : 11/19/21 10:20 AM
# @Author  : Wizard Chenhan Zhang
# @FileName: test_nipa.py
# @Software: PyCharm
...
env = NodeInjectionEnv(features, labels, idx_train, idx_val, dict_of_lists, victim_model, ratio=args.ratio,
...
warnings.warn(
    'If you find the training process is too slow, you can uncomment line 207 in deeprobust/graph/utils.py. Note that you need to install torch_sparse')
